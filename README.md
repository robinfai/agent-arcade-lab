...
本项目的程序辅助能力参考了 [mizorewww/laya-mlx](https://github.com/mizorewww/laya-mlx/tree/main) 的实现，尤其是贪吃蛇的循环安全层、候选动作描述与安全动作纠正，并结合本项目的游戏规则扩展了俄罗斯方块落点评价和双蛇防循环辅助。感谢原项目的开源工作；参考代码以固定版本保存在 `vendor/laya-mlx` 子模块中，并保留其 Apache-2.0 许可证及相关声明。
