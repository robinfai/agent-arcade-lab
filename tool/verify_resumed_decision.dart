...
void main(List<String> args) {
  ...
  for (final file
    ...
    if (!['decision-v1', 'decision-v1-resumed'].contains(summary['schema'])) {
    ...
    if (cap < 1 ||
        (summary['schema'] == 'decision-v1'
            ? summary['requests'] > summary['max_requests']
            : summary['unlimited_request_retries'] != true ||
                  summary['max_requests'] != null ||
                  summary['decisions'] > cap)) {
  ...
  stdout.writeln(
    'Verified $runs decision/recovery runs, $actions actual actions; no strategy correction, all within recorded caps.',
  );
}
